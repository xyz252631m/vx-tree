    ...
    <div class="virtual-tree-menu">
        <ul :style="treeStyle">
            <li v-for="m in showList" :key="m.id"
                :class="[{'open-li':m.expand,'active':m.id===activeId,'hover-active':hoverSelectId===m.id},'level-li-' + m.level,
                drag.borItem===m?drag.borCls:'']"
            ...
            >
                ...
                <span class="arrow" v-if="m.children && m.children.length" @click="changeExpand(m)">
                    ...
                    >
                    <span class="icon-box">
                        <slot name="icon" :item="m.data" :expand="m.expand">
    ...
    export default {
        ...
        methods: {
            ...
            contextmenu(e, item) {
                ...
                this.drag.borItem = null;
                this.drag.borCls = "";
                this.$emit("on-contextmenu", e, item);
            },
            changeExpand(item) {
